...
class Facet implements ModelInterface, ArrayAccess
{
     ...
     * Sets name
     *
     * @param string|null $name The name of the facet (as set in the request). If name is not specified in the request parameter this will be the requested attributeName.
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string|null $type The type of the facet (as set in the request).
     *
     * @return $this
     */
