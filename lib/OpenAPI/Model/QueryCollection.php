...
/**
 * QueryCollection Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class QueryCollection implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'queryCollection';
     ...
     * Sets count
     *
     * @param int|null $count The number of queries in this collection.
     *
     * @return $this
     */
    public function setCount($count)
    {
        ...
        if (!is_null($count) && ($count > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $count when calling QueryCollection., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($count) && ($count < 0)) {
            throw new \InvalidArgumentException('invalid value for $count when calling QueryCollection., must be bigger than or equal to 0.');
        }
     ...
     * Sets items
     *
     * @param object[]|null $items The queries.
     *
     * @return $this
     */
