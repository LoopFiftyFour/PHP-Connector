<?php
/*
 * This file is the versioned combination of the source files in the top
 * directory. include_once this file, and you should be set!
 */
...
abstract class Loop54_RequestHandling
{
	public static function getResponse($engineUrl, $request)
	{
		...
		try {
			...
			curl_setopt($s,CURLOPT_HTTPHEADER,array('Content-Type: application/json; charset=UTF-8','Lib-Version: PHP:2018-11-22T122149','Api-Version: V26'));
